...
const m1 = list1.map(dobro); //o parâmetro dobro é apenas uma referência para o método dobro. Por isso não precisa colocar os ().
...
// satisfazem um dado predicado (predicado é uma função que retorna verdadeiro ou falso).

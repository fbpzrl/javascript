...
const r1 = nomes.pop(); //Remove o último elemento do Array e o retorna para a const r1
const r2 = nomes.shift(); //Remove o primeiro elemento do Array e o retorna para a const r2
